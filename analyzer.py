...
def analyze_reviews(reviews):
    ...
    pos_percent = round((sentiment_counts['Positive'] / total_polarized * 100), 1) if total_polarized > 0 else 0
    neg_percent = round((sentiment_counts['Negative'] / total_polarized * 100), 1) if total_polarized > 0 else 0
